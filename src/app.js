...
allProjects.addTodo(defaultProject.id, 'NewTodo');
renderProjects(mainProjectsDiv, allProjects.projects);
todoView(mainTodosDiv, defaultProject.id, defaultProject.todos);
//
